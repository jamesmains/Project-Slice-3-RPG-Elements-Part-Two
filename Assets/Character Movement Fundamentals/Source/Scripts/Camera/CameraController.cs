...
namespace CMF
{
	...
	public class CameraController : MonoBehaviour {
		...
		void Awake () {
			...
			cameraInput = GetComponentInParent<PlayerInput>();
		...
		void Update()
		{
			...
			else RotateTowardPosition(DEBUG_Target.position,cameraSpeed);
		}
		...
		protected virtual void HandleCameraRotation()
		{
			...
			//Get input values;
			Vector2 _lookInput = cameraInput.GetPlayerLookInput();
		
			RotateCamera(_lookInput.x, _lookInput.y);
		}
